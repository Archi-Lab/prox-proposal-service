...
public class SampleData implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public void onApplicationEvent(ContextRefreshedEvent arg0) {
    ...
    // proposalRepository.save(new Proposal("project123", "supervisor123", "student123", "Dies ist
    // ein Test", 1));
    // proposalRepository.save(new Proposal("project456", "supervisor456", "student456", "Dies ist
    // ein Test2", 1));
